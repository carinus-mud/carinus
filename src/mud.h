...
#define LEVEL_HERO		   (MAX_LEVEL - 25)
...
extern const char *cpose_table[MAX_CLASS][MAX_LEVEL + 1][2];
extern const char *hometown_table[MAX_CLASS][MAX_LEVEL + 1][2];
extern const char *customclass_table[MAX_CLASS][MAX_LEVEL + 1][2];
...
DECLARE_DO_FUN( do_mp_grant );
DECLARE_DO_FUN( do_mp_ungrant );
...
/* act_info.c */
	  HELP_DATA * get_help	args( (CHAR_DATA *ch, const char *argument) );
...
void do_build_walk( CHAR_DATA *ch, const char *argument );
...
void set_cpose args( ( CHAR_DATA * ch, const char *cpose ) );
void set_hometown args( ( CHAR_DATA * ch, const char *hometown ) );
void set_customclass args( ( CHAR_DATA * ch, const char *customclass ) );
